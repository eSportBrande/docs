...
![Change Password / Skift min adgangskode](./steam/skins-taget-imgs/changepassword.png "Change Password / Skift min adgangskode")
...
4. Det kan være en god idé at skifte dit password til din E-Mail også. Det er sjældent den vej de kommer ind, men for en sikkerheds skyld vil vi anbefale det.
...
![Deauthorize all devices / Fjern godkendelse af alle enheder](./steam/skins-taget-imgs/deauthorize.png "Deauthorize all devices / Fjern godkendelse af alle enheder")
...
![Revoke my Steam API Key / Tilbagekald min Steam Web API-nøgle](./steam/skins-taget-imgs/api-revoke.png "Revoke my Steam API Key / Tilbagekald min Steam Web API-nøgle")

Det skal gerne se sådan her ud, når du er færdig:

![Create API Key / Opret API nøgle](./steam/skins-taget-imgs/api-create.png "Create API Key / Opret API nøgle")

Når du er færdig med disse steps, så har du sikret din Steam-konto, og ingen andre kan logge ind på den uden din Steam Guard-kode og din nye adgangskode. Herefter kan vi gå videre til næste step, som handler om at tjekke op på om dine skins er væk.
...
Hvis du kan se at dine skins er blevet tradet væk, så kan du gå videre til næste step, hvis ikke så er du heldig og dine skins er stadig på din konto og kan gå i gang med at spille igen.

## Reverse et trade
Som noget nyt (Juli 2025) har Steam/Valve gjort det muligt at reverse trades inden for 7 dage af en trade har fundet sted. Det betyder at hvis du har opdaget at dine skins er blevet tradet væk, så kan du få dem tilbage igen, indenfor 7 dage.
